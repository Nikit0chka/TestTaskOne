...
/// <summary>
/// Сервис работы с окном выбора файлов
/// </summary>
public interface IFilePickerDialogService
{
    ...
    /// <param name="allowMultiple">Разрешить выбор нескольких файлов (влияет только на заголовок, но метод вернёт первый выбранный).</param>
